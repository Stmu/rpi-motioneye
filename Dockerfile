...
RUN apt-get update && apt-get install -f build-essential python-pip python-dev curl libssl-dev default-libmysqlclient-dev libcurl4-openssl-dev libjpeg-dev libx264-148 libavcodec57 libavformat57 libswscale4 libpq5 wget libraspberrypi-bin
